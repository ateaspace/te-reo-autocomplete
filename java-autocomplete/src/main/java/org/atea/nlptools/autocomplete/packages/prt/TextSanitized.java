...
public class TextSanitized implements Serializable {
    ...
    public TextSanitized(String unSanitizedText) {
        ...
        for (int i = 0; i < unSanitizedTextChars.length; i++) {
            ...
            String s_af_lc = s_af.toLowerCase();
    ...
    protected static TextSanitized suffixTextSanitized(TextSanitized parentTextSanitized, int sanitizedBeginIndex) {
        ...
        try {
            ...
            System.err.println("unSanitizedBeginIndex: " + unSanitizedBeginIndex);
            System.err.println("sanitizedBeginIndex: " + sanitizedBeginIndex);
            System.err.println("parentTextSanitized.originalText: " + parentTextSanitized.originalText);
            System.err.println("parentTextSanitized.sanitizedText: " + parentTextSanitized.sanitizedText);
            System.err.println("parentTextSanitized.unSanitizedText: " + parentTextSanitized.unSanitizedText);
            System.err.println("childTextSanitized.sanitizedText: " + childTextSanitized.sanitizedText);
            System.err.println("s2omapping: " + Arrays.toString(parentTextSanitized.s2o_mapping));
            e.printStackTrace();
            // throw e;
        }
